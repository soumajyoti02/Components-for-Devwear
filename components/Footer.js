    ...
    return (
        <>
            <footer className="text-gray-600 body-font">
                <div className=" px-5 md:pl-[5.25rem] py-12 mx-auto flex md:items-center lg:items-center md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <Link href={`/`} className="flex title-font  items-center md:justify-start justify-center text-gray-900 text-4xl font-bold">
                            DEVWEAR
                        </Link>
